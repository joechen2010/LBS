 ...
 * @date 2011.02.22
 */
@Path(SingleReceivedMessageRessource.URI_TEMPLATE)
@Stateless
public class SingleReceivedMessageRessource {
    private static final String TAG = "de.gfred.lbbms.service.resources.SingleReceivedMessageRessource";
    private static final boolean DEBUG = false;
    public static final String URI_TEMPLATE = ReceivedMessagesRessource.URI_TEMPLATE + "/{" + ResourceValues.MESSAGE_ID + ": [0-9]+}";
    ...
    public void removeMsg(@HeaderParam(ResourceValues.TOKEN) String token, @PathParam(ResourceValues.CUSTOMER_ID) Long id, @PathParam(ResourceValues.MESSAGE_ID) Long msgId){
        ...
        Message msg = messageBean.getMessageById(msgId);
        customer.getReceivedMessages().remove(msg);
