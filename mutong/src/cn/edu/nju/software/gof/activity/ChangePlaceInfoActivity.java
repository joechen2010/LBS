...
public class ChangePlaceInfoActivity extends Activity {
	...
	private String placeID, placeName,placeDescription;
	Bitmap avatar;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		placeDescription = bundle.getString("placeComment");
		setViews();
	}
	...
	private void setViews(){
		...
		place_comment.setText(placeDescription);
		place_image.setImageBitmap(avatar);
	}
	...
	private void registerEventHandler() {
		...
		submit.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				//
				MyApplication application = (MyApplication) ChangePlaceInfoActivity.this
						.getApplication();
				...
				if (avatar != null) {
					...
					(new AsyncTask<Void, Void, Void>() {
						...
						protected Void doInBackground(Void... params) {
							PlaceModification bean = new PlaceModification();
							bean.setImage(image);
							bean.setPlaceDescription(placeDescription);
							bean.setPlaceName(placeName);
							success = PlaceUtilities.modifyPlace(sessionID, placeID, bean);
							return null;
						...
						protected void onPostExecute(Void result) {
							...
							if (success) {
								Toast toast = NotifyUtilities
										.createMessageToast(
												ChangePlaceInfoActivity.this,
												"更新成功");
								toast.show();
								setResult(Activity.RESULT_OK);
								ChangePlaceInfoActivity.this.finish();
							} else {
