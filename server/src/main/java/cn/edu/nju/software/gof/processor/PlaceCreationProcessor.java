...
public class PlaceCreationProcessor implements RequestProcessor {
	...
	public void process(HttpServletRequest request, HttpServletResponse response)
		...
		String placeName = (String) request.getAttribute(ServletParam.RequestParam.PlaceName);

		String parentID = (String) request.getAttribute(ServletParam.RequestParam.ParentID);
		...
		placeCreation.setImages((byte[]) request.getAttribute(ServletParam.RequestParam.Image));
